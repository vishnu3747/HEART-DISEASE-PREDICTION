...
def takeInput():
    ...
    if final_Result[0] == 1:
        ...
        label2 = tkinter.Label(substituteWindow, text="PLEASE VISIT NEAREST CARDIOLOGIST AT THE EARLIEST", font=('Impact', -20), fg='blue')
        label2.grid(row=2, column=1, columnspan=6)
        
    else: 
        label1 = tkinter.Label(substituteWindow, text="NO DETECTION OF HEART DISEASES", font=('Impact', -35), fg='green' )
        label1.grid(row=1, column=1, columnspan=6)
        label2 = tkinter.Label(substituteWindow, text="Do not forget to exercise daily. ", font=('Impact', -20))
        label2.grid(row=2, column=1, columnspan=6)      
...
sexFrame = tkinter.LabelFrame(mainWindow, text="Sex(1=Male,0=Female")
